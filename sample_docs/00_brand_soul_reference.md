...
### Archetype
**Primary:** artisan_master (confidence: 0.95)
...
| Energy | calm |
| Humor | subtle |
| Technical Depth | enthusiast |
| Emotional Register | trust |

### Linguistic Rules
| Rule | Setting |
|------|---------|
| Sentence Style | flowing_narrative |
| Person Voice | first_person_plural |
| Active/Passive | active_preferred |
| Jargon | embrace |

### Power Words (MUST USE)
handcrafted, heritage, artisan, heirloom, kiln-fired, provenance, timeless, purposeful, tactile, enduring, soul, reverence, mastery, lineage, intentional

### Banned Phrases (NEVER USE)
cheap, bargain, deal, discount, mass-produced, factory-made, fast, best ever, amazing, incredible, game-changer, hack, must-have, OMG, limited-time offer
...
_The brand strongly embodies the Artisan Master archetype through its emphasis on handcraftsmanship, single-artisan production, and detailed 23-step process. The Heritage House is a strong secondary archetype given the four-generation lineage and founding in 1923. The tonal guardrails reflect the brand's stated voice: 'quiet confidence — never shouting, always inviting.'_
...
### Chunk 1
Takumi Ceramics is a fourth-generation family workshop founded in 1923 in Arita, Saga Prefecture. We believe in Yō-no-bi — the beauty of use — creating functional pieces meant to be touched, used, and loved daily.

**Entities:** region:Arita, philosophy:Yō-no-bi, time_period:1923

### Chunk 2
Each piece passes through 23 steps over 6 weeks. Local Amakusa clay is hand-wedged, wheel-thrown by a single artisan, bisque-fired at 900°C, hand-painted with natural Gosu cobalt pigments, celadon glaze-dipped, and final-fired at 1300°C for 36 hours.

**Entities:** material:Amakusa clay, material:Gosu cobalt, technique:wheel-thrown, technique:celadon glaze, process:23-step process

### Chunk 3
Core Pillars: Heritage & Authenticity — four generations, one unbroken lineage, zero shortcuts. Functional Beauty (Yō-no-bi) — made to be used, not displayed. Material Integrity — Amakusa clay, Gosu pigments, proprietary celadon glaze. Sustainable Craft — zero-waste kiln cycles, rainwater clay processing.

**Entities:** philosophy:Yō-no-bi, attribute:sustainable, certification:zero-waste

---

## Products Used in Sample Docs

### Celadon Jade Rice Bowl — 翡翠茶碗
- **ID:** gid://shopify/Product/12345
- **Category:** Tableware
- **Price:** ¥12,800
- **Tags:** rice-bowl, celadon, handcrafted, arita, gift
- **Description (JP):** 手作りの青磁茶碗。天草陶石を使用し、匠の職人が一つ一つ轆轤で成形。1300°Cで36時間焼成した「翡翠のささやき」仕上げ。日常使いのための機能美。直径12cm、高さ7cm。食洗機対応。...

### Gosu Blue Side-Handle Teapot — 呉須横手急須
- **ID:** gid://shopify/Product/67890
- **Category:** Tea Ware
- **Price:** ¥28,500
- **Tags:** teapot, gosu-blue, handpainted, tea-ceremony, arita
- **Description (JP):** 呉須で手描きされた横手急須。天草陶石使用。茶こし一体型。容量350ml。お茶の旨みを最大限に引き出す内側無釉仕上げ。...

### Noborigama Ash Glaze Flower Vase — 登り窯灰釉花瓶
- **ID:** gid://shopify/Product/11223
- **Category:** Vases & Décor
- **Price:** ¥45,000
- **Tags:** vase, ash-glaze, noborigama, wabi-sabi, one-of-a-kind
- **Description (JP):** 登り窯で焼かれた灰釉花瓶。自然の灰が窯の中で溶け、一つとして同じ模様のない偶然の美を生み出します。高さ25cm。一輪挿しに最適。...
