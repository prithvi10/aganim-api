...
from src.shared.config.prompts import BRAND_CONTEXT_FILE_EXTRACT_PROMPT
from src.shared.logging.logger import get_logger
from src.ecommerce.db.transactions import record_successful_rewrite
from src.ecommerce.db.transactions import increment_monthly_rewrites_used  # backwards-compat for tests/patches
...
try:
    ...
    logger.warning("SSL context init failed; using default httpx client: %s", exc)
    http_client = httpx.Client()
